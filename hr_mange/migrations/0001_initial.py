# Generated by Django 5.0 on 2024-01-21 09:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('sem1', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem2', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem3', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem4', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem5', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem6', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem7', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem8', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem10th', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('sem12th_diploma', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('std_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr_mange.student')),
            ],
        ),
    ]
